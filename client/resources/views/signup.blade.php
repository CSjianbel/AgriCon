...
@section('content')
    <div class="px-10 flex items-center justify-center h-screen">
        <form class="w-full">
            ...
            <hr class="mb-6">
            <button type="submit" class="text-white mb-6 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center">Create Account</button>
