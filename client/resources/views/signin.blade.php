    ...
    <div class="px-10 flex items-center justify-center h-screen">
        <div class="w-full">
            ...
            <form class="w-full"  action="{{ route('login') }}" method="POST">
                ...
                <button type="submit" class="text-white bg-[#1CB87E] hover:bg-[#168a5f] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-4 text-center mb-6">Sign In</button>
                <div class="flex flex-row gap-x-2">
                    <p>Don't have an account?</p>
                    <a href="{{ route('signup') }}" class="text-[#1CB87E]">Create an account</a>
                </div>
            </form>
        </div>
